...
import researchman from './manual/Research Internship Program 2022-204.pdf';

const Research = () => {
    const policies = [
      {
        title: "Research Internship Policy",
        file: researchman,
        bgColor: "#9b59b6"
        },
        {
          title: "Research Internship Reports",
          file: "https://placements.spit.ac.in/statistics",
          bgColor: "#4a90e2"
          },
